<template>
  <div class="ui-cell-swipe-box" @touchstart="_touchStart" @touchmove="_touchMove" @touchend="_touchEnd">
    <div class="ui-cell-swipe" :style="txtStyle">
      <slot></slot>
    </div>
    <div class="ui-cell-swipe-footer" ref="right">
      <slot name="right">
      </slot>
    </div>
  </div>
